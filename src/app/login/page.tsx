    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-md rounded-2xl glass-panel p-8 border border-white/15 bg-slate-950/95 relative z-10 space-y-6 shadow-2xl backdrop-blur-2xl">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Sign in to track your goals, streaks, and habits</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-indigo-500/15 border border-indigo-500/35 text-indigo-300 hover:bg-indigo-500/25 text-xs font-black transition-all shadow-sm active:scale-98"
        >
